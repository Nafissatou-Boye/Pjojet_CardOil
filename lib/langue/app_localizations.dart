...
const _fr = _Translations(
   welcomeTitle: 'Bienvenue sur CardOil', welcomeGreeting: 'Bienvenue',
  ...
  alreadyHaveAccount: 'Vous avez déjà un compte ?', noAccount: 'Pas de compte ?',
  forgotPassword: 'Mot de passe oublié ?', recentTransactions: 'Transactions récentes',
  otpTitle: 'Vérification', otpSending: 'Envoi du code SMS...',
  otpEnterCode: 'Entrez le code reçu par SMS', otpSentTo: 'Code envoyé à',
  otpValidate: 'Valider', otpResend: 'Renvoyer le code',
  otpResendIn: 'Renvoyer dans', otpModifyNumber: 'Changer de numéro',
  otpWaiting: 'Veuillez patienter quelques secondes',
  ...
  otpNetworkError: 'Erreur réseau. Vérifiez votre connexion.',
  hello: 'Bonjour', balance: 'Solde disponible', loyaltyPoints: 'Points de fidélité',
  history: 'Historique', profile: 'Profil', home: 'Accueil',
  fuel: 'Carburant', carWash: 'Lavage Auto', maintenance: 'Entretien carburant',
  otherServices: 'Autres services', promotions: 'Promotions',
  noPromotion: 'Aucune promotion en cours',
  monthlyExpenses: 'Dépenses mensuelles', noTransaction: 'Aucune transaction pour le moment',
  scanQr: 'Scanner le QR Code', confirmPayment: 'Confirmer le paiement', amount: 'Montant',
  paymentSuccess: 'Paiement réussi !',
  product: 'Produit', station: 'Station', attendant: 'Agent',
  willBeDebited: 'sera débité de votre solde',
  receiptTitle: 'Reçu client', date: 'Date', reference: 'Référence', client: 'Client',
  amountPaid: 'Montant payé', thankYou: 'Merci pour votre fidélité',
  print: 'Imprimer', ok: 'Ok', download: 'Télécharger le reçu',
  successStatus: 'Réussi', pendingStatus: 'En attente', cancelledStatus: 'Annulé',
  verified: 'Vérifié', payment: 'Paiement', recharge: 'Recharger',
  connectToAccount: 'Connectez-vous à votre compte',
  phoneTab: 'Téléphone', identifierTab: 'Identifiant',
  enterPhone: 'Entrez le numéro de téléphone', yourIdentifier: 'Votre identifiant (8 chiffres)',
  ...
  confirmPassword: 'Confirmez le mot de passe', acceptTerms: 'Conditions d\'utilisation',
  ...
  canChangeLater: 'Vous pourrez le changer plus tard',
  acceptConditions: 'Acceptez les conditions pour continuer',
  availableBalance: 'Solde disponible', loyaltyPointsLabel: 'Points de fidélité',
  statusVerified: 'Vérifié', statusNotVerified: 'Non vérifié', status: 'Statut',
  seeAll: 'Voir tout', transactions: 'transaction', thisMonth: 'ce mois-ci',
  chooseCompanyPrompt: 'Choisissez une compagnie',
  wash: 'Lavage Auto', fuelMaintenance: 'Entretien\nCarburant', other: 'Autres\nServices',
  profileTitle: 'Profil', informations: 'Informations',
  preferredCompany: 'Compagnie préférée', qrCode: 'QR Code',
  helpCenter: 'Centre d\'aide', about: 'À propos',
  logout: 'Se déconnecter', logoutConfirmTitle: 'Se déconnecter',
  logoutConfirmContent: 'Voulez-vous vraiment vous déconnecter ?',
  disconnect: 'Se déconnecter', appVersion: '© 2026 Card Oil',
  editProfile: 'Modifier le profil', saveChanges: 'Enregistrer',
  profileUpdated: 'Profil mis à jour avec succès',
  updateError: 'Erreur de mise à jour', notConnected: 'Utilisateur non connecté', readOnly: 'Téléphone',
  registrationSuccess: 'Inscription réussie', redirecting: 'Redirection...',
  registrationTitle: 'Inscription', required: 'Requis', errorUnknown: 'Erreur inconnue',
  historyTitle: 'Historique', noTransactionYet: 'Aucune transaction pour le moment',
  ...
  privacyTitle: 'Politique de confidentialité', contactUs: 'Contactez-nous', yesterday: 'Hier',
  clientReceiptTitle: 'Reçu d\'achat client', downloadReceipt: 'Télécharger le reçu',
  loyaltyPointsReceiptLabel: 'Points de fidélité :',
  myQrCode: 'Mon QR Code', scanQrStation: 'Scanner le code de la station',
  ...
  invalidQr: 'QR Code invalide', paymentSuccessMsg: 'Paiement réussi !',
  ...
  paymentSuccessTitle: 'Paiement réussi', receiptNumber: 'Numéro du reçu',
  compagnie: 'Compagnie', paymentMethod: 'Méthode de paiement',
  cashbackEarned: 'Cashback obtenu', transactionId: 'ID de transaction',
  ...
  seeDetails: 'Voir les détails', expired: 'Expiré',
  ...
  participationError: 'Erreur lors de la participation', promoNotFound: 'Promotion non trouvée',
  maskCard: 'Masquer la carte',
  privacyIntro: 'Chez Senpay, nous nous engageons à protéger la vie privée et la sécurité des informations personnelles de nos utilisateurs. Cette politique décrit comment nous collectons, utilisons et protégeons vos informations.',
  privacySection1Title: '1. Informations que nous collectons',
  privacySection1Content: 'Informations personnelles : nom, adresse e-mail, numéro de téléphone lors de la création du compte ou d\'une transaction.\n\nInformations d\'utilisation : comment vous interagissez avec notre application.',
  privacySection2Title: '2. Comment nous utilisons vos informations',
  privacySection2Content: 'Pour fournir nos services, traiter les transactions et gérer votre compte.\n\nPour améliorer nos services et analyser les tendances d\'utilisation.\n\nPour vous envoyer des mises à jour et notifications importantes.',
  privacySection3Title: '3. Partage d\'informations',
  privacySection3Content: 'Senpay ne partage pas vos informations avec des prestataires tiers.',
  privacySection4Title: '4. Sécurité des données',
  privacySection4Content: 'Nous mettons en place des mesures de sécurité standard pour protéger vos informations contre tout accès non autorisé.',
  privacySection5Title: '5. Vos choix',
  privacySection5Content: 'Vous pouvez accéder, mettre à jour ou supprimer vos informations personnelles en contactant notre support.',
  privacySection6Title: '6. Vie privée des enfants',
  privacySection6Content: 'Nos services ne sont pas destinés aux personnes de moins de 18 ans. Nous ne collectons pas sciemment de données auprès des mineurs.',
...
const _en = _Translations(
  welcomeTitle: 'Welcome to CardOil', welcomeGreeting: 'Welcome',
  ...
  forgotPassword: 'Forgot password?', recentTransactions: 'Recent Transactions',
...
const _ar = _Translations(
  welcomeTitle: 'مرحباً بك في CardOil', welcomeGreeting: 'مرحباً',
